...
Zeon is a self-hosted solution, which means that you have full control over your data and how it is stored. You can choose to store your data on your own hardware or on a cloud provider of your choice. Contact us if you need help setting up Zeon on your own provider, hardware or explore available options.
